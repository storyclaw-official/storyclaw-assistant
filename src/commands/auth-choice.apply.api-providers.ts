...
import {
  ...
  applyStoryclawApConfig,
  applyStoryclawApProviderConfig,
  applyStoryclawUsConfig,
  applyStoryclawUsProviderConfig,
...
const SIMPLE_API_KEY_PROVIDER_FLOWS: Partial<Record<AuthChoice, SimpleApiKeyProviderFlow>> = {
  ...
  "storyclaw-api-key": {
    ...
    expectedProviders: ["storyclaw"],
    envLabel: "STORYCLAW_API_KEY",
    promptMessage: "Enter StoryClaw API key",
    setCredential: setStoryclawApiKey,
    defaultModel: STORYCLAW_DEFAULT_MODEL_REF,
    applyDefaultConfig: applyStoryclawApConfig,
    applyProviderConfig: applyStoryclawApProviderConfig,
  ...
  "storyclaw-us-api-key": {
    ...
    setCredential: setStoryclawApiKey,
    defaultModel: STORYCLAW_DEFAULT_MODEL_REF,
    applyDefaultConfig: applyStoryclawUsConfig,
    applyProviderConfig: applyStoryclawUsProviderConfig,
    noteDefault: STORYCLAW_DEFAULT_MODEL_REF,
    noteMessage: "Get your API key at https://app.storyclaw.com",
