...
describe("checkBrowserOrigin", () => {
  it.each([
    ...
    {
      name: "accepts loopback origins even when gateway is non-loopback",
      input: {
    ...
    {
      name: "accepts loopback 127.0.0.1 origins even when gateway is non-loopback",
      input: {
        requestHost: "device.tail1234.ts.net",
    ...
    {
      name: "accepts loopback origins regardless of isLocalClient",
      input: {
        requestHost: "127.0.0.1:18789",
    ...
    {
      name: "accepts builtin StoryClaw origin (storyclaw.com)",
      input: {
        requestHost: "device.tail1234.ts.net",
    ...
    {
      name: "accepts builtin StoryClaw origin (app.storyclaw.com)",
      input: {
        requestHost: "device.tail1234.ts.net",
